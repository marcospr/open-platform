...
public class CriarPedidoDTO implements Serializable {

	private static final long serialVersionUID = 1L;
	@JsonProperty("data")
    private CriarPedido data;
    @JsonProperty("error")
    private Error error;
    @JsonIgnore
    ...
    @JsonProperty("data")
    public CriarPedido getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(CriarPedido data) {
        this.data = data;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CriarPedidoDTO) == false) {
            return false;
        }
        CriarPedidoDTO rhs = ((CriarPedidoDTO) other);
