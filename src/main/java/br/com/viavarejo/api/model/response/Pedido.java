...
@JsonPropertyOrder({ "valorProduto", "valorTotalPedido", "codigoPedido", "pedidoParceiro", "idPedidoMktplc", "produtos",
		"parametrosExtras", "aguardandoConfirmacao", "dadosEntrega", "dadosPagamentoComplementar" })
public class Pedido implements Serializable {
	...
	*/
	...
	public int hashCode() {
		...
		result = ((result * 31)
				+ ((this.dadosPagamentoComplementar == null) ? 0 : this.dadosPagamentoComplementar.hashCode()));
	...
	public boolean equals(Object other) {
		...
		return ((((((((((((this.codigoPedido == rhs.codigoPedido)
				|| ((this.codigoPedido != null) && this.codigoPedido.equals(rhs.codigoPedido)))
				&& ((this.dadosPagamentoComplementar == rhs.dadosPagamentoComplementar)
						|| ((this.dadosPagamentoComplementar != null)
								&& this.dadosPagamentoComplementar.equals(rhs.dadosPagamentoComplementar))))
				&& ((this.valorTotalPedido == rhs.valorTotalPedido)
						|| ((this.valorTotalPedido != null) && this.valorTotalPedido.equals(rhs.valorTotalPedido))))
				&& ((this.pedidoParceiro == rhs.pedidoParceiro)
						|| ((this.pedidoParceiro != null) && this.pedidoParceiro.equals(rhs.pedidoParceiro))))
				&& ((this.produtos == rhs.produtos) || ((this.produtos != null) && this.produtos.equals(rhs.produtos))))
				&& ((this.parametrosExtras == rhs.parametrosExtras)
						|| ((this.parametrosExtras != null) && this.parametrosExtras.equals(rhs.parametrosExtras))))
				&& ((this.aguardandoConfirmacao == rhs.aguardandoConfirmacao) || ((this.aguardandoConfirmacao != null)
						&& this.aguardandoConfirmacao.equals(rhs.aguardandoConfirmacao))))
				&& ((this.dadosEntrega == rhs.dadosEntrega)
						|| ((this.dadosEntrega != null) && this.dadosEntrega.equals(rhs.dadosEntrega))))
				&& ((this.valorProduto == rhs.valorProduto)
						|| ((this.valorProduto != null) && this.valorProduto.equals(rhs.valorProduto))))
				&& ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null)
						&& this.additionalProperties.equals(rhs.additionalProperties))))
				&& ((this.idPedidoMktplc == rhs.idPedidoMktplc)
						|| ((this.idPedidoMktplc != null) && this.idPedidoMktplc.equals(rhs.idPedidoMktplc))));
	}
